...
// TODO: Hacer visualización (o sea, todo :-))
...
/** Utilidad de visualización de objetos y sus atributos, usando reflectividad (accede a todos los atributos, aunque sean privados).
...
public class VisualizadorObjetos {
	...
	public static String atributosYValoresToString( String mens, String sep, Object o, boolean tbStatic, boolean mostrarTam, String camposAMostrar ) {
		VisualizadorObjetos.camposAMostrar = camposAMostrar;
	...
	public static void main(String[] args) {
		...
		System.out.println( Integer.toHexString( System.identityHashCode( oo ) ) );
